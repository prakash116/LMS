  ...
  return (
    <>
      <div className="flex justify-between ">
        <div className="w-1/2 flex flex-col justify-top gap-2 pt-10 items-center">
          ...
          <div className="flex gap-2">
            <NavLink
              to="/login"
              className="btn border-t-2 border-b-2 border-0 rounded-2xl bg-indigo-950/90 px-10 border-amber-100"
            >
              Login
            </NavLink>
            <NavLink
              to="/register"
              className="btn border-t-2 border-b-2 border-0 rounded-2xl bg-indigo-950/90 px-8 border-amber-100"
            >
              SignUp
            </NavLink>
          </div>
