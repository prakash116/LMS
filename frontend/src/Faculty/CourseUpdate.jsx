...
function CourseUpdate({ setShowUpdate, id }) {
  ...
  return (
    <div className="w-300 bg-zinc-800/90 h-screen p-10 flex justify-center items-center font-serif">
      <div className="bg-zinc-950/70 border-t-2 border-b-2 rounded-lg p-10 pl-15 pr-0">
        <div className="flex justify-center pb-4">
          <h1 className="border-b-1 w-fit rounded-2xl -ml-18 px-4 bg-zinc-800 p-1">
        ...
        {setShowUpdate && (
          <div
            ...
            className="flex justify-end items-end absolute top-22 right-45 p-2 rounded-full hover:bg-red-500 cursor-pointer"
          >
            <ImCross />
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="flex flex-col justify-center items-center">
          ...
          <button type="submit" className="btn btn-outline px-8 btn-success -ml-18">
            Update
          </button>
        </form>
      </div>
