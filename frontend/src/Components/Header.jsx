  ...
  return (
    <div>
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center">
            <NavLink to="/" className="flex items-center p-2">
              <img src="/Images/icon.png" alt="Logo" className="h-12 md:h-14" />
            </NavLink>
          ...
          <div className="flex items-center gap-4">
            {!user ? (
              <>
                <NavLink to="/register">
                  <button className="px-4 py-2 md:px-8 md:py-2.5 font-semibold rounded dark:bg-violet-900 border-r-2 border-l-2 hover:border-amber-300 hover:text-amber-200 dark:text-gray-50">
                    Sign Up
                  </button>
                </NavLink>
                <NavLink to="/login">
              ...
              <>
                <button className="flex gap-3 justify-center items-center">
                  <h1 className="hidden md:block font-semibold text-l">
                  ...
                  <img
                    ...
                    alt="Profile"
                    className="w-10 h-10 bg-amber-200 rounded-full cursor-pointer"
                  />
                </button>
              </>
            )}
      ...
      <div className="flex absolute w-full h-[100vh] top-0" style={sidebar}>
        ...
        ></div>
        <div className="w-full md:w-1/3 bg-indigo-950/90">
          ...
          <div className="flex justify-center flex-col -mt-5 items-center">
            <img
              onClick={handleSidbar}
              src={profile ? `http://localhost:8585/${role}/${profile}` : null}
              alt="Imge"
